...
def flaws_multiselect_kb(selected: set[str], mode: str) -> InlineKeyboardMarkup:
    """mode: 'flaws' или 'tolerance' — влияет на callback_data префикс и кнопку 'Готово'."""
    b = InlineKeyboardBuilder()
...
def main_menu_kb() -> InlineKeyboardMarkup:
    b = InlineKeyboardBuilder()
    b.button(text="🔍 Смотреть анкеты", callback_data="menu:browse")
    b.button(text="💞 Мои мэтчи", callback_data="menu:matches")
    b.button(text="👤 Моя анкета", callback_data="menu:profile")
    b.adjust(1)
    return b.as_markup()
